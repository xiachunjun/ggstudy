...
import com.ggstudy.springboot.model.MockRequest;
import com.ggstudy.springboot.model.UserReq;
import com.ggstudy.springboot.model.XMLRoot;
...
//        userService.updateUser(user);
    ...
    public Object login(@RequestBody Map<String, String> param) {
        ...
        return new HashMap<String,Object>(){{put("xmlResp",res);}};
    }
    ...
    public UserReq jsonPost(@RequestBody UserReq userReq) {
        return userReq;
    }

    @RequestMapping(value = "/jsonPost1",produces = {"application/json"})
    public Request jsonPost1(@RequestBody Request request) {
        return request;
    }
    ...
    public List<String> xmlTest() {
        ...
        stringList.add(String.format("%10d", time));
        return stringList;
    }

    public static void main(String[] args) {
        Long time = System.nanoTime();
        System.out.println(String.format("%10d", time));
    }


    @RequestMapping(value = "/xmlPost", produces = {"application/json", "application/xml"})
    public XMLRoot xmlPost(@RequestBody MockRequest request) {
        XMLRoot xml=new XMLRoot();
        xml.setJo(JSON.toJSON(request));
        return xml;
    }
